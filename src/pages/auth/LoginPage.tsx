                ...
                <div className="mt-6">
                    <div className="relative">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-2 bg-[#151A21] text-gray-500">Or continue with</span>
                        </div>
                    </div>

                    <button
                        onClick={handleGoogleLogin}
                        className="mt-6 w-full bg-[#0B0E11] border border-[#2A3441] hover:bg-[#1C232E] text-white font-medium py-3 rounded-lg flex items-center justify-center transition-colors"
                    >
